    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="../actions/login_action.php?op=in" method="POST">
                ...
                ?>
                <button type="submit" name="login" value="Login" class="btn btn-warning block full-width m-b">Login</button>

                <a href="./forget_password.php"><small>Forgot password?</small></a>
                <p class="text-muted text-center"><small>Do not have an account?</small></p>
                <a class="btn btn-sm btn-white btn-block bg-success" href="../templates/register.php">Register</a>
            </form>
