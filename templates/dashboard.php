        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <!-- Restaurants -->
                    <li class="#">
                        <a href="#"><i class="fa-solid fa-store"></i> <span class="nav-label">Restaurants</span> <span class="fa arrow"></span></a>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row wrapper-content ">
                                <div class="col-md-4 border-top-bottom p-xs">
                                    ...
                                    <a href="#" class="btn btn-info btn-lg btn-block m-t">Manage Restaurants</a>
                                </div>
                                <div class="col-md-4 border-top-bottom p-xs">
                                    <h3> Manage Foods </h3>
