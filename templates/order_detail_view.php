...
<head>
    ...
    <title>Dine In Hub | Order Details</title>
            ...
            <div class="row wrapper-content">
                <div class="col-lg-12 ">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h2 class="border-top-bottom border-left-right p-sm text-center"><strong>Order Details</strong></h2>
                        ...
                        <?php if (!empty($order_details)) : ?>
                            <form id="delete_form" method="post" action="../actions/delete_order_item.php">
                                            ...
                                            <table class="table shoping-cart-table m-t-xs">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="delete_items[]" value="<?php echo htmlspecialchars($row['food_id']); ?>">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="ibox-content text-center">
                                    <button type="button" class="btn btn-danger" id="delete_button"><i class="fa fa-trash"></i> Delete Selected Items</button>
                                </div>
                            </form>
                        <?php endif; ?>
                    </div>
                ...
                <script>
                    document.getElementById('delete_button').addEventListener('click', function() {
                        ...
                        const checkedItems = form.querySelectorAll('input[name="delete_items[]"]:checked');

                        if (checkedItems.length > 0) {
                            Swal.fire({
                                title: 'Apakah anda yakin menghapus item?',
                                icon: 'warning',
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title bg-success text-center">
                        <h2><strong>Dine In Hub | Order Details Page</strong></h2>
                    </div>
                    <div class="ibox-title">
                        <h2 class="border-top-bottom border-left-right p-sm text-center"><strong>Order Details</strong></h2>
                        <span class="form-control bg-primary">
