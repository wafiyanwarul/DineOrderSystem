                        ...
                        <div class="col-lg-12">
                            <div class="ibox btn-block float-e-margins">
                                <div class="ibox-title" style="display: flex; align-items: center; justify-content: space-between;">
                                    <h2 class="m-b-sm border-right">Update Restaurant Data : <strong id="restaurant-name-display"><?php echo htmlspecialchars($restaurant['restaurant_name'] ?? ''); ?></strong></h2>
                                    <div class="ibox-tools">
                                        <button id="save-data-btn" class="btn btn-primary" type="button" style="display: none;"><i class="fa fa-check"></i>&nbsp;Save</button>
                                        <button id="edit-data-btn" class="btn btn-info" type="button"><i class="fa fa-paste"></i> Edit</button>
                                    </div>
                                </div>
                ...
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox btn-block float-e-margins">
                                <div class="ibox-title" style="display: flex; align-items: center; justify-content: space-between;">
                                    <h2 class="m-b-sm border-right">Update Image : <strong id="restaurant-image-display"><?php echo htmlspecialchars($restaurant['restaurant_name'] ?? ''); ?></strong></h2>
                                    <div class="ibox-tools">
                                        <button id="save-image-btn" class="btn btn-primary" type="button" style="display: none;"><i class="fa fa-check"></i>&nbsp;Save</button>
                                        <button id="edit-image-btn" class="btn btn-info" type="button"><i class="fa fa-paste"></i> Edit</button>
                                    </div>
                                </div>
                                <div class="ibox-content">
                                    ...
                                    <form id="restaurant-image-form" action="update_restaurant_image.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
            ...
            <?php } elseif ($level == 'customer') { ?>
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox">
                                <img alt="image" class="img-fluid rounded-circle" src="../<?php echo htmlspecialchars($restaurant['image'] ?? ''); ?>">
