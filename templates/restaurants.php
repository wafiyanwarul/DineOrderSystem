            ...
            <?php if ($level == 'admin') { ?>
                <div class="row wrapper-content">
                    <div class="col-lg-12 m-b-none">
                        ...
                        <div class="ibox-content">
                            <a class="b-r-xl bg-success" href="./add_restaurant.php">
                                <div class="btn btn-success btn-block dim">
                                ...
                                <div class="col-lg-3">
                                    <div class="contact-box center-version">
                                        <a href="./restaurant_detail.php?id=<?php echo $restaurant['restaurant_id']; ?>">
                                            <img alt="image" class="img-fluid img-circle" style="max-width: 100%; max-height: 100%; object-fit: cover; display: block; margin: 0 auto;" src="../<?php echo htmlspecialchars($restaurant['image'] ?? ''); ?>">
                                        ...
                                        <div class="contact-box-footer">
                                            <div class="m-t-xs btn-group">
                                                <a class="btn btn-xs btn-white bg-info"><i class="fa-solid fa-cart-shopping"></i> Order Here </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php if (!empty($restaurants)) : ?>
                    <?php foreach ($restaurants as $restaurant) : ?>
                        <div class="col-lg-3">
                            <div class="contact-box center-version">
                                <a href="./restaurant_detail.php?id=<?php echo $restaurant['restaurant_id']; ?>">
                                    <img alt="image" class="img-fluid img-circle" src="../<?php echo htmlspecialchars($restaurant['image'] ?? ''); ?>">
                                    <h3 class="m-b-xs"><strong><?php echo htmlspecialchars($restaurant['restaurant_name'] ?? ''); ?></strong></h3>
                                    <div class="font-bold"><?php echo htmlspecialchars($restaurant['address'] ?? ''); ?></div>
                                    <address class="m-t-md">
                                        <strong><?php echo htmlspecialchars($restaurant['phone'] ?? ''); ?></strong><br>
