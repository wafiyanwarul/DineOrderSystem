...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO food (restaurant_id, category_id, food_name, price, description, image) VALUES ('$restaurant_id', '$category_id','$food_name', '$price', '$description', '$target_file')";
